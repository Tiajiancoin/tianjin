...
Arguments:
    <base_directory> - The base directory of a Tiajians Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Tiajians Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Tiajians Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Tiajians
