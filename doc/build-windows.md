...
Below are some notes on how to build Tiajians Core for Windows.
...
way. This will install to `c:\workspace\tiajians`, for example:

    make install DESTDIR=/mnt/c/workspace/tiajians
