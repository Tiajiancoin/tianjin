...
Tiajians Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Tiajians Core, where everyone uses
...
pay attention to for reviewers of Tiajians Core code.

General Tiajians Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Tiajians Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Tiajians Core so that they can be integrated
