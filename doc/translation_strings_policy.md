...
This document provides guidelines for internationalization of the Tiajians Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tiajians_en.ts` remains unchanged.
