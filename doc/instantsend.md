...
This mechanism has been integrated into Bitcore-Node-Tiajians which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tiajians/insight-api-tiajians#web-socket-api](https://github.com/tiajians/insight-api-tiajians#web-socket-api)
* API: [https://github.com/tiajians/insight-api-tiajians#instantsend-transactions](https://github.com/tiajians/insight-api-tiajians#instantsend-transactions)
